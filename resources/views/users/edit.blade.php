                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control border-input" placeholder="Email" id="email" name="email" value="{{ $user->email }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Username</label>
                                <input type="text" class="form-control border-input" placeholder="Username" id="username" name="username" value="{{ $user->email }}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-input" placeholder="e.g Office" id="location" name="location" disabled>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
